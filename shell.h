...
int cmd_d_append(int argc, char **argv); /* Syscalls: open, write, close */
...
/* --- Categoría: Listado (cat_listado.c) --- */
int cmd_l_dir(int argc, char **argv);     /* Syscalls: opendir, readdir, closedir */

/* --- Categoría: Editor (cat_editor.c) --- */
int cmd_editor(int argc, char **argv);    /* Syscalls: open, read, write, lseek, ftruncate, close */

/* --- Utilidad compartida (definida en main.c) --- */
int parse_line(char *line, char **argv);  /* Tokeniza una línea de entrada, reutilizada por cat_editor.c */
#endif /* SHELL_H */
